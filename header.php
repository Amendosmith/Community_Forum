...
<br>
	...
	<div id="menu">
		<a class="item" href="/proj/index.php">Home</a> -
		<a class="item" href="/proj/create_topic.php">Create a topic</a>
...
$_SESSION['user_level'] = NULL;
  ...
  {
  	echo ' - <a class="item" href="/proj/message.php">Send Message</a>';
  	echo ' - <a class="item" href="/proj/inbox.php?id=0">Inbox</a>';
  ...
  if($_SESSION['signed_in'] == true && $_SESSION['user_level'] == 2)
  {
  	...
  	echo ' - <a class="item" href="user.php?id=0">Profile</a>';
		...
		{	
			echo ' - <a class="item" href="/proj/create_cat.php">Create a category</a>';
			echo ' - <a class="item" href="/proj/message.php">Send Message</a>';
			echo ' - <a class="item" href="/proj/inbox.php?id=0">Inbox</a>';
			echo ' - <a class="item" href="user.php?id=0">Profile</a>';
			echo ' - <a class="item" href="admin_panel.php?id=0">Admin Panel</a>';
